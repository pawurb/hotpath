...
pub mod tests {
    ...
    // cargo run -p test-channels-asc --example basic_asc --features hotpath
    #[test]
    ...
    // cargo run -p test-channels-asc --example closed_asc --features hotpath
    #[test]
    ...
    // cargo run -p test-channels-asc --example iter_asc --features hotpath
    #[test]
    fn test_iter_output() {
        let output = Command::new("cargo")
            .args([
    ...
    // cargo run -p test-channels-asc --example slow_consumer_asc --features hotpath
    #[test]
