...
impl AllocGuard {
    ...
    pub fn new(name: &'static str) -> Self {
        ...
        crate::alloc_count_max::core::ALLOCATIONS.with(|stack| {
            let mut s = stack.borrow_mut();
            s.depth += 1;
            assert!((s.depth as usize) < crate::alloc_count_max::core::MAX_DEPTH);
...
impl Drop for AllocGuard {
    ...
    fn drop(&mut self) {
        ...
        let alloc_info = crate::alloc_count_max::core::ALLOCATIONS.with(|stack| {
            let mut s = stack.borrow_mut();
            let depth = s.depth as usize;
